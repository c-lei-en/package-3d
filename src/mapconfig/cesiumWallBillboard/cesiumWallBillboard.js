...
(function() {
  ...
  CesiumWallBillboard.prototype._AddEntity = function(_this, image) {
    _this._entities = _this._viewer.entities.add({
      wall: {
        positions: new Cesium.CallbackProperty((time, result) => {
          if (result) {
            var cameraposition = _this.Utils.cartesianToLonlat(
              _this._viewer.camera.position
            );
        ...
        minimumHeights: [
          _this._center.height - _this.height / 2,
          _this._center.height - _this.height / 2
        ],
        maximumHeights: [
          _this.height / 2 + _this._center.height,
          _this.height / 2 + _this._center.height
        ],
  ...
  Cesium.CesiumWallBillboard = CesiumWallBillboard;
})();
